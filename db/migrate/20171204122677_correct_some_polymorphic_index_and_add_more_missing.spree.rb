...
class CorrectSomePolymorphicIndexAndAddMoreMissing < ActiveRecord::Migration[4.2]
  def change
    ...
    remove_index :spree_adjustments, %i[source_type source_id]
    add_index :spree_adjustments, %i[source_id source_type]
    ...
    add_index :spree_log_entries, %i[source_id source_type]
    ...
    add_index :spree_orders_promotions, %i[order_id promotion_id]
    add_index :spree_payments, %i[source_id source_type]
    ...
    add_index :spree_state_changes, %i[stateful_id stateful_type]
    ...
    add_index :spree_zone_members, %i[zoneable_id zoneable_type]
